...
VALUES	(1,'Gabriel Santos','1995-07-08'),
		(2,'Felipe Vieira','1965-10-08'),
		(3,'Marcos Araújo','1997-10-08'),
		(4,'João Fontes','1987-01-08'),
		(5,'Roberto Silva','1974-07-09'),
        (6,'Maria Santos','1990-07-08'),
        (7,'Roberval Vieira','1964-02-08'),
        (8,'Sandra Araújo','1954-02-06'),
        (9,'Mário Fontes','1993-01-04'),
        (10,'Marilda Silva','1974-09-09'),
		(11,'Sergio Antunes','1957-10-10'),
		(12,'Paulo Antunes','1992-09-09'),
		(13,'Danilo Magalhães','1974-12-12'),
		(14,'Osvaldo Magalhães','1987-09-12'),
		(15,'Larissa Santana','1953-12-06'),
		(16,'Joséfa Santana','1987-09-01'),
		(17,'Melissa Garcia','1992-09-02'),
		(18,'Jorge Garcia','1996-10-10'),
		(19,'Bruno Viana','1997-11-11'),
		(20,'Marcio Viana','1998-12-12');
